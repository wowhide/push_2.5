...
class AndroidTwentyEighthDeathdayPushNotifier {
    public function push() {
        try {
            ...
            // 今日配信のお知らせが存在するかチェック
            $noticeSQL = "SELECT * FROM t_notice_info WHERE notice_schedule = 28282828";
            ...
            foreach ($noticeList as $notice) {
                // ログ出力文字列を初期化
                $strSendRegistra = "四七日通知:" . $notice['notice_info_no'] . "\n";
