...
class AndroidFortySecondDeathdayPushNotifier {
    public function push() {
        try {
            ...
            // 今日配信のお知らせが存在するかチェック
            $noticeSQL = "SELECT * FROM t_notice_info WHERE notice_schedule = 42424242";
            ...
            foreach ($noticeList as $notice) {
                // ログ出力文字列を初期化
                $strSendRegistra = "六七日通知:" . $notice['notice_info_no'] . "\n";
